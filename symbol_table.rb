...
class Function < Entry
  attr_accessor :parameters, :instructions, :scope, :returns

  def initialize(parameters, instructions, scope, returns, line_number)
  ...
  def graphical
    puts "TODO Function graphical print"
  end
end
